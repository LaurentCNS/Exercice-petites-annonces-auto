 ...
 */
final class Version20220830074151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE listing ADD model_id INT DEFAULT NULL, CHANGE production_year produced_year INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE listing DROP model_id, CHANGE produced_year production_year INT NOT NULL');
